...
import { ElevationGain } from 'shared/components/icons/icons';
...
const Cycling: FC = () => {
	...
	const { name, duration, distance, heart_rate, steps, elevation_gain } = activities[1];
				...
				<div className='flex flex--wrap  justify-content--between'>
					<div className='activity-detail__box flex flex--row justify-content--around align-items--center border-radius--xxl'>
						<div className='flex flex--column'>
							<p className='font-size--22 line-height--28 font--light text--light-blue'>Steps taken</p>
							<h6 className='no--margin mt--15 font-size--30 line-height--28 font--medium'>
								<CountUp end={steps as number} duration={1} className='font-size--30' />
							</h6>
						</div>
						<div className='steps-image '>
							<img src={step} alt='steps-img' className='image' />
						</div>
					</div>
					<div className='activity-detail__box flex flex--row justify-content--around align-items--center border-radius--xxl'>
						<div className='flex flex--column'>
					...
					<div className='activity-detail__box flex flex--row justify-content--around align-items--center border-radius--xxl'>
						<div className='flex flex--column'>
							<p className='font-size--22 line-height--28 font--light text--light-blue'>Elevation gain</p>
							<h6 className='no--margin mt--15 font-size--30 line-height--28 font--medium'>
								{elevation_gain}
								<span>m</span>
							</h6>
						</div>
						<ElevationGain height='65px' width='65px' className='fill--green' />
					</div>
				</div>
